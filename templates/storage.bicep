...
resource deploymentScript 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    arguments: '-ResourceGroupName ${resourceGroup().name} -StorageAccountName ${uniqueString(resourceGroup().id)} -IndexDocument ${indexDocument} -ErrorDocument404Path ${errorDocument404Path}'
  }
}
